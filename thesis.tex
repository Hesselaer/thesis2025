...
\begin{abstract}
\noindent
We introduce ranked hypergraphs which give dependency hypergraphs interfaces, this results in associative sequential composition. We prove these graphs have as generator the graphs of depth 1. Putting these graphs in a simplicial context allows us to 
\end{abstract}
...
\subsection{Higher Dimensional Automata}
